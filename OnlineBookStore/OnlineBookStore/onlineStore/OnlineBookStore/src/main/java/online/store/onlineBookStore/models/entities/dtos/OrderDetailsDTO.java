...
public class OrderDetailsDTO {
    ...
    public OrderDetailsDTO setPerson(String person) {
        this.person = person;
        return this;
    }
    ...
    public OrderDetailsDTO setCountry(String country) {
    ...
    public OrderDetailsDTO setPhone(String phone) {
        this.phone = phone;
        return this;
    }
    ...
    public OrderDetailsDTO setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public OrderDetailsDTO setPostalCode(String postalCode) {
    ...
    public OrderDetailsDTO setCourier(String courier) {
